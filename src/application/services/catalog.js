...
export const TOOL_CATALOG = Object.freeze([
  ...
  tool("changes.analyze", "AnalyzeChangeService", PERMISSIONS.MUTATE, "command", "VersionedItemCommand"),
  tool("changes.decide", "DecideChangeService", PERMISSIONS.DECIDE, "command", "DecisionRequest"),
  tool("changes.implement", "ImplementChangeService", PERMISSIONS.MUTATE, "command", "VersionedItemCommand"),
  tool("changes.close", "CloseChangeService", PERMISSIONS.DECIDE, "command", "DecisionRequest"),
